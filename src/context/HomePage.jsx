...
export default function HomePage() {
  ...
  return (
    <>
      <Typography
        variant="h3"
        sx={{ textAlign: "center", color: "#FFC0CB", mb: 3 }}
      >
        Bouty food
      </Typography>
        ...
        {products.map((product) => (
          ...
          >
            <CardContent>
              ...
              />
              <Typography variant="h5" sx={{ color: "#FFC0CB" }}>
                {product.name}
              </Typography>
              <Typography variant="body2" sx={{ color: "#FFC0CB" }}>
                {product.title}
              </Typography>
              ...
              <Button
                ...
                sx={{ backgroundColor: "#FFC0CB", color: "black", mt: 1 }}
              >
                <ShoppingCartIcon /> הוסף לעגלה
              </Button>
            </CardContent>
          </Card>
        ))}
